...
Ext.ux.grid.GridFilters = function(config){		
	this.filters = new Ext.util.MixedCollection();	this.filters.getKey = function(o){return o ? o.dataIndex : null};
...
Ext.extend(Ext.ux.grid.GridFilters, Ext.util.Observable, {
	...
	buildQuery: function(filters){
		...
		for(var i=0, len=filters.length; i<len; i++){
			var f    = filters[i];			var root = [this.paramPrefix, '[', i, ']'].join('');			p[root + '[field]'] = f.field;			
