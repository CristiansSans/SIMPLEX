...
-- Tiempo de generación: 07-04-2022 a las 13:04:33
...
--
-- Base de datos: `simplex1_sqm_sgl`
--
...
CREATE DEFINER=`simplex1`@`localhost` PROCEDURE `prc_container_importar` (IN `codOrden` INT, IN `contenedor` VARCHAR(50) CHARSET utf8, IN `sello` VARCHAR(50) CHARSET utf8, IN `peso` INT, IN `codMedida` INT, IN `codCondicion` INT, IN `observaciones` VARCHAR(200))  NO SQL
...
CREATE DEFINER=`simplex1`@`localhost` PROCEDURE `prc_hitoingresado_editar` (IN `codservicio` INT, IN `numhito` INT, IN `hora` VARCHAR(10))  BEGIN
	/*Atributos*/
    declare lnexiste 			int;
        ...
        if time(hora) is null then
            ...
            if lnexiste > 0 then
                ...
                set     hico.hico_horareal = time(hora),
                        ...
                        -- hico.hico_horaplan = time(time(ldservinicio) + sec_to_time(lnTiempoViaje*60))
                where  serv_ncorr = codservicio
                       and hito_ncorr = numhito;
            else
...
CREATE DEFINER=`simplex1`@`localhost` PROCEDURE `prc_hitosingresados_listar` (IN `codservicio` INT)  BEGIN
    SELECT  tise.tise_vdescripcion tiposervicio,
            ...
            hito.hito_km km,
            TIME_FORMAT(ADDTIME(time(serv.serv_dinicio),sec_to_time(hito.hito_tiempoviaje*60)),'%H:%i') horaprogramada,
            TIME_FORMAT(time(time(serv.serv_dinicio) + sec_to_time(hito.hito_tiempoviaje*60)),'%H:%i') horaprogramadaold,
            TIME_FORMAT(hico.hico_horareal,'%H:%i') horareal
    FROM    tg_hito hito
...
CREATE DEFINER=`simplex1`@`localhost` PROCEDURE `prc_seguimientotransporte_listar` (IN `codorden` INT, IN `codcliente` INT, IN `codtransportista` INT, IN `inicioperiodo` DATE, IN `terminoperiodo` DATE)  BEGIN
    SELECT     serv.car_ncorr,
               ...
               time(serv.serv_dinicio) inicioplan,
               if(avance.controlado = 1, avance.inicioreal,  time(serv.serv_dinicio)) inicioreal,
               time(serv.serv_dtermino) terminoplan,
               avance.controlado,
               ...
               CONCAT(max(hito.hito_km),' Kms') movimiento,
               '0 km' distancia ,
               if (avance.controlado=1,avance.ultimoavance, time(serv.serv_dinicio)) uavance,
if (avance.controlado=0,null,if(avance.inicioreal< avance.inicioplan,0, (minute(timediff(avance.inicioplan, avance.inicioreal))+ 60 *hour(timediff(avance.inicioplan, avance.inicioreal))))) atrasoinicio,
...
(90914000, 'Moletto', '', 'Pablo Saavedra', 'Av. Matucana 1223', NULL, NULL, 'Santiago', 'Manufacturas Textiles', '56 9 87464245', '', 10, 'Moletto Hermanos S.A.', 'Comercialización de Textiles'),
...
(38, NULL, 'Moletto - Pto Madero', 'Purto Madero 9710 Bodega Z19', 'L0035', 'Santiago', 4, NULL, 1, 1, 1),
...
(4, 'Transporte de Contenedores', 7, 1, 41, 93515000, 244000),
(5, 'Transporte de Contenedores IMO', 7, 1, 41, 93515000, 279500),
(6, 'Transporte de Contenedores ', 7, 5, 41, 93515000, 244000);
...
(2, 1, 'Estadia'),
(3, 1, 'Seguro'),
(4, 1, 'Gastos Aduaneros'),
(5, 1, 'Custodia'),
(6, 1, 'Representantes'),
(7, 5, 'Recepcion y despacho de contenedor');
...
(126, '', NULL, NULL, NULL, NULL, NULL, NULL, 'Observaciones', 1, NULL, 55, 1, NULL, NULL, NULL, NULL, '', 0, 14, 0, '0000-00-00', NULL),
(127, '', NULL, NULL, NULL, NULL, NULL, NULL, 'Observaciones', 1, NULL, 55, 1, NULL, NULL, NULL, NULL, '', 0, 14, 0, '0000-00-00', NULL),
(128, '999999', NULL, NULL, NULL, NULL, NULL, NULL, '', 2, NULL, 55, 1, NULL, NULL, NULL, NULL, '45465', 0, 14, 0, '0000-00-00', NULL),
(129, '837557', NULL, NULL, NULL, NULL, NULL, NULL, '', 2, NULL, 55, 1, NULL, NULL, NULL, NULL, '4343545', 0, 14, 0, '0000-00-00', NULL),
(130, '111111111', NULL, NULL, NULL, NULL, NULL, NULL, '', 2, NULL, 55, 1, NULL, NULL, NULL, NULL, '22222222', 0, 14, 0, '0000-00-00', NULL),
(131, '2222222222', NULL, NULL, NULL, NULL, NULL, NULL, '', 2, NULL, 55, 1, NULL, NULL, NULL, NULL, '333333333', 0, 14, 0, '0000-00-00', NULL),
(132, '1', NULL, NULL, NULL, NULL, NULL, NULL, '', 2, NULL, 55, 1, NULL, NULL, NULL, NULL, '2', 0, 14, 0, '0000-00-00', NULL),
(133, '', NULL, NULL, NULL, NULL, NULL, NULL, 'Observaciones', 1, NULL, 55, 1, NULL, NULL, NULL, NULL, '', 0, 14, 0, '0000-00-00', NULL),
(134, '', NULL, NULL, NULL, NULL, NULL, NULL, 'Observaciones', 1, NULL, 55, 1, NULL, NULL, NULL, NULL, '', 0, 14, 0, '0000-00-00', NULL),
(135, '', NULL, NULL, NULL, NULL, NULL, NULL, 'Otros', 1, NULL, 55, 1, NULL, NULL, NULL, NULL, '', 0, 14, 0, '0000-00-00', NULL),
(136, '', NULL, NULL, NULL, NULL, NULL, NULL, '', 1, NULL, 55, 1, NULL, NULL, NULL, NULL, '', 0, 14, 0, '0000-00-00', NULL),
...
(140, '', NULL, NULL, NULL, NULL, NULL, NULL, '', 2, NULL, 56, 2, NULL, NULL, NULL, NULL, '', 0, 12, 0, '0000-00-00', NULL),
(142, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin Observaciones', 1, NULL, 56, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '0000-00-00', NULL),
(143, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin Observaciones 2', 1, NULL, 56, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '0000-00-00', NULL),
(144, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin Observaciones', 1, NULL, 56, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '0000-00-00', NULL),
(145, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin Observaciones 2', 1, NULL, 56, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '0000-00-00', NULL);
...
(10, NULL, 'Alexis Gajardo', '17.980.526-k', 49, '+56 9 65628370'),
(11, NULL, 'GermÃ¡n Oyarce', '16.555.795-k', 49, '+56 9 7035630'),
(12, NULL, 'Juan Oyarce', '10.161.180-9', 49, '+56 90113083');
...
(1, 'Transportes San Pablo', '88128400-6', 'Longitudinal Sur KM 202, Molina', 'Transporte', NULL, NULL, NULL, '', '', 1),
...
(7, 'Vitorio Romanini', '7675870-0', '', 'Transporte', NULL, NULL, NULL, '', '', 0),
...
(42, 'RESTAURANT MAYLU', '10.508.921-K', NULL, 'Transporte', NULL, NULL, NULL, '', '', 0),
...
(47, 'Transporte de Contenedores de Chile SA', '76566490-K', NULL, 'Transporte', NULL, NULL, NULL, '', '', 0),
(49, 'German Andres Oyarce Ramirez', '16.555.759-k', '', 'Transporte de Carga', 'Germán Oyarce', ' 56 (9) 50005570', 'transportes_agm@live.cl', 'German Andres Oyarce Ramirez', 'Transporte con  Rampla', 0);
...
CREATE TABLE `tg_hitocontrolado` (
  ...
  `HICO_HORAPLAN` time DEFAULT NULL COMMENT 'Hora planeada',
  `HICO_HORAREAL` time DEFAULT NULL COMMENT 'Hora real'
...
--
-- Estructura de tabla para la tabla `vw_tramo`
--
...
CREATE TABLE `vw_tramo` (
  ...
  `tra_kms` int(11) DEFAULT NULL,
  `tra_tiempo` int(11) DEFAULT NULL,
  `nombre` varchar(404) DEFAULT NULL
...
--
ALTER TABLE `tg_carga`
  MODIFY `CAR_NCORR` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de la carga', AUTO_INCREMENT=146;

--
-- AUTO_INCREMENT de la tabla `tg_detallefactura`
--
ALTER TABLE `tg_detallefactura`
  MODIFY `DEFA_NCORR` double NOT NULL AUTO_INCREMENT COMMENT 'Id. del detalle de la factura', AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `tg_guiatransporte`
--
ALTER TABLE `tg_guiatransporte`
  MODIFY `guia_ncorr` double NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT de la tabla `tg_log`
--
ALTER TABLE `tg_log`
  MODIFY `log_ncorr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=244;

--
-- AUTO_INCREMENT de la tabla `tg_ordenservicio`
--
ALTER TABLE `tg_ordenservicio`
  MODIFY `OSE_NCORR` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador del registro';

--
-- AUTO_INCREMENT de la tabla `tg_servicio`
--
ALTER TABLE `tg_servicio`
  MODIFY `serv_ncorr` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id. de la programación';

--
-- AUTO_INCREMENT de la tabla `tg_tramo`
--
ALTER TABLE `tg_tramo`
  MODIFY `TRA_NCORR` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id. del tramo', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `tg_tramo_subtiposervicio`
--
ALTER TABLE `tg_tramo_subtiposervicio`
  MODIFY `tss_ncorr` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
